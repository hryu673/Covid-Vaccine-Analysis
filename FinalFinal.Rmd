...
In order to identify the possible maximums of our log-likelihood function, we took the first derivative of our log-likelihood with repects to the parameter of interest, $\psi_0$, and found the root(s) of the equation.
\begin{align*}
